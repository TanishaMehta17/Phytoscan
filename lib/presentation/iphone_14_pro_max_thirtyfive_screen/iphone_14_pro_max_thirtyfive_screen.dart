...
class Iphone14ProMaxThirtyfiveScreen extends StatefulWidget {
  ...
  @override
  State<Iphone14ProMaxThirtyfiveScreen> createState() => _Iphone14ProMaxThirtyfiveScreenState();
}

class _Iphone14ProMaxThirtyfiveScreenState extends State<Iphone14ProMaxThirtyfiveScreen> {
    ...
    return Align(
        ...
        child: Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text("Eucalyptus Plant", style: theme.textTheme.displaySmall),
              Padding(
                  padding: EdgeInsets.only(left: 68.h, top: 5.v),
    ...
    return Padding(
        ...
        child: Row(children: [
          ...
          Padding(
              ...
              child: Text("Eucalyptus teriticornis",
    ...
    return Padding(
        ...
        child: Row(children: [
          ...
          Container(
              ...
              child: Text("It is used to counter cough and cold products .",
                  maxLines: 3,
